...
<script>
import ViCollapseTransitionGroup from './components/vi-collapse/vi-collapse-transition-group.js'
import ViSwipe from './components/vi-swipe/vi-swipe.vue'
import ViSwipeGroup from './components/vi-swipe/vi-swipe-group.vue'
...
export default {
  components: {
    ViCollapseTransitionGroup,
    ViSwipeGroup,
    ViSwipe
  },
  data() {
    return {
      swipeData: customDatas,
      options: {
        probeType: 3,
        click: true,
