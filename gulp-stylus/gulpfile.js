...
gulp.task('less',function(){
	...
	.pipe(gulp.dest('resource/less-css'))
});

gulp.task('stylus',function(){
	return gulp.src('resource/stylus/**/*.styl')
	.pipe(plumber({
		errorHandler : function(){
			this.emit('end');
		}
    ...
    //     // 保留autoprefixer的特殊前缀
   	// }))
	.pipe(gulp.dest('resource/stylus-css'))
});
...
gulp.task('serve',['stylus'],function() {
    ...
    gulp.watch("resource/less-css/*.css").on('change', browserSync.reload);
    gulp.watch("resource/stylus-css/*.css").on('change', browserSync.reload);
