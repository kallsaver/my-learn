...
.hahow {
  ...
  color: #fff;
  font-family: "Playfair Display", "微软正黑体";
  .content {
    display: block;
    .remind {
      opacity: 0.2;
    ...
    .switch:checked + .scene {
      // background-position的百分比定位
      // rate = x / (contentWidth - wrapperWidth)
      background-position: 0 100%;
    }
    .switch:checked + .scene .moon {
      top: -100px;
      opacity: 0;
    }
