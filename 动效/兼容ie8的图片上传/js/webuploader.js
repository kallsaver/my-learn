...
(function( window, undefined ) {
    ...
    define( 'widgets/upload', [
        ...
        Uploader.register({
            ...
            _doSend: function( block ) {
                ...
                // 在发送之间可以添加字段什么的。。。
                // 如果默认的字段不够使用，可以通过ЫСхРмцндф║Лф╗╢цЭецЙйх▒Х
            ...
            _finishFile: function( file, ret, hds ) {
                ...
                return owner
                        ...
                        .fail(function( reason ) {
                            ...
                            // хжВцЮЬхдЦщГих╖▓ч╗ПцаЗшо░ф╕║invalidф╗Аф╣ИчЪДя╝Мф╕НхЖНцФ╣чК╢цАБуАВ
                            if ( file.getStatus() === Status.PROGRESS ) {
                                file.setStatus( Status.ERROR, reason );
                            }
    ...
    /**
     * @fileOverview хРДчзНщкМшпБя╝МхМЕцЛмцЦЗф╗╢цА╗хдзх░ПцШпхРжш╢ЕхЗ║уАБхНХцЦЗф╗╢цШпхРжш╢ЕхЗ║хТМцЦЗф╗╢цШпхРжщЗНхдНуАВ
     */
    ...
    define( 'widgets/validator', [
        ...
        // хЬиUploaderхИЭхзЛхМЦчЪДцЧ╢хАЩхРпхКиValidatorsчЪДхИЭхзЛхМЦ
        Uploader.register({
            init: function() {
                var me = this;
         ...
         * @namespace options
         * @for Uploader
         * @description щкМшпБцЦЗф╗╢цА╗цХ░щЗП, ш╢ЕхЗ║хИЩф╕НхЕБшо╕хКахЕещШЯхИЧуАВ
         */
         ...
         * @namespace options
         * @for Uploader
         * @description щкМшпБцЦЗф╗╢цА╗хдзх░ПцШпхРжш╢ЕхЗ║щЩРхИ╢, ш╢ЕхЗ║хИЩф╕НхЕБшо╕хКахЕещШЯхИЧуАВ
         */
         ...
         * @namespace options
         * @for Uploader
         * @description щкМшпБхНХф╕кцЦЗф╗╢хдзх░ПцШпхРжш╢ЕхЗ║щЩРхИ╢, ш╢ЕхЗ║хИЩф╕НхЕБшо╕хКахЕещШЯхИЧуАВ
         */
         ...
         * @namespace options
         * @for Uploader
         * @description хО╗щЗНя╝М ца╣цНоцЦЗф╗╢хРНхнЧуАБцЦЗф╗╢хдзх░ПхТМцЬАхРОф┐оцФ╣цЧ╢щЧ┤цЭечФЯцИРhash Key.
         */
    ...
    /**
     * @file цЪ┤щЬ▓хПШщЗПч╗ЩхдЦщГиф╜┐чФиуАВ
     * цндцЦЗф╗╢ф╣ЯхПкцЬЙхЬицККwebuploadхРИх╣╢цИРф╕Аф╕кцЦЗф╗╢ф╜┐чФичЪДцЧ╢хАЩцЙНф╝Ъх╝ХхЕеуАВ
     *
     * х░ЖцЙАцЬЙmodulesя╝Мх░Жш╖пх╛ДidsшгЕцНвцИРхп╣ш▒буАВ
     */
    (function( modules ) {
        var
            // шойщжЦхЖЩхнЧцпНхдзхЖЩуАВ
