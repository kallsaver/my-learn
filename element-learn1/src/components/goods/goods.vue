...
export default {
  ...
  created() {
    ...
    // console.log(this._props.obj.name === this.obj.name);
    //console.log('this._props.obj === this.obj',this._props.obj === this.obj);
    // props传的是指针,但是vue1中this._props是另外一个东西
    //console.log('Vue.obj === this.obj',Vue.obj === this.obj);
    //console.log(Vue.obj === this.$data.obj);
    // this._props.obj = {
    //     name: 'new obj'
    // }
