  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <ratingselect
        ...
        :ratings="ratings"
        @betterScrollRefresh="betterScrollRefresh">
      </ratingselect>

      <div class="rating-wrapper">
        <ul class="rating-ul" v-if="showList.length">
          <li v-for="(rating, index) in showList" :key="index" class="rating-item">
            <div class="avatar">
        ...
        <div v-if="!showList.length" class="no-rating">暂无符合的数据</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    console.log('rating beforeRouteLeave');
    // 如果下个页面是keep-alive的,那么跳转的时候读取内存的页面
  ...
  deactivated() {
    console.log('rating deactivated');
  },
  created() {
